                ...
                <div className="mt-6 space-y-4 text-xs leading-6 text-gray-600">
                  <div className="flex gap-x-3">
                    ...
                    <address className="not-italic">
                      <p>First Floor, Vikiye Center,<br />Opp. Notun Bosti Gate, Fellowship Colony</p>
                      <p><span>Dimapur</span>, <span>Nagaland</span> <span>797112</span></p>
                    </address>
                  </div>
                  <div className="flex gap-x-3">
                    ...
                    <a href="tel:+918798587779" className="hover:text-gray-900">+91-8798-587779</a>
                  </div>
                </div>
              </div>
            </div>
