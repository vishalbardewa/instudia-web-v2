        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0" itemScope itemType="http://schema.org/LocalBusiness">
                <h3 className="text-sm font-semibold leading-6 text-gray-900">
                  Contact Us
                </h3>
                <div className="mt-6 space-y-4 text-xs leading-6 text-gray-600">
                  <div className="flex gap-x-3">
                    ...
                    <address className="not-italic" itemProp="address" itemScope itemType="http://schema.org/PostalAddress">
                      <p itemProp="streetAddress">First Floor, Vikiye Center,<br />Opp. Notun Bosti Gate, Fellowship Colony</p>
                  ...
                  <div className="flex gap-x-3">
                    ...
                    <a href="tel:+918798587779" className="hover:text-gray-900" itemProp="telephone">+91-8798-587779</a>
                  </div>
                </div>
              </div>
            </div>
