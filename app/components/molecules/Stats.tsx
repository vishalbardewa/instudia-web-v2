          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-6xl text-center">
              ...
              <p className="mt-3 px-10 text-base text-gray-500 sm:mt-4">
                We understand that the cost of education can be a barrier for
                many individuals, which is why we offer affordable training
                programs that are accessible to everyone. Our courses are
                designed to be flexible, allowing students to learn at their own
                pace and on their own schedule. We also offer financing options
                and scholarships to ensure that cost is not a barrier to
                education.
              </p>
            </div>
          </div>
