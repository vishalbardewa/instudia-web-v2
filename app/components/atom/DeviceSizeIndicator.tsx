...
const DeviceSizeIndicator = ({ enable = true }: any) => {
    if (process.env.NODE_ENV === "development" && enable) {
      return (
        <div className="fixed bottom-4 left-4 p-3 text-xs font-mono text-white h-6 w-6 rounded-full flex items-center justify-center bg-gray-700 sm:bg-pink-500 md:bg-orange-500 lg:bg-green-500 xl:bg-blue-500 z-[200] shadow-md opacity-75 hover:opacity-100 transition-opacity">
