...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://instudianagaland.com/tools/career-guide" },
  openGraph: {
    ...
    url: 'https://instudianagaland.com/tools/career-guide',
    siteName: 'Instudia',
    images: [
      {
        url: 'https://instudianagaland.com/assets/images/career-guide-og.jpg', // Placeholder for actual OG image
        width: 1200,
        height: 630,
